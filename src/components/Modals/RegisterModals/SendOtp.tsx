import { FlowbiteFloatingLabelTheme } from "flowbite-react";
...
export const SendOtpInput = forwardRef<HTMLInputElement, FloatingLabelProps>(
  (
    {
      label,
      helperText,
    ...
    return (
      <div>
        ...
        >
          ...
          {isTimerActive && (
            <div className="absolute right-4 top-1/2 transform -translate-y-1/2 text-xs text-gray-600 dark:text-gray-400">
              {timeLeft}s
            </div>
          )}
          {!isTimerActive && (
            <button
              ...
              className="absolute right-4 top-1/2 transform text-xs -translate-y-1/2 text-blue-600 dark:text-blue-500 focus:outline-none"
            >
              SendOTP
            </button>
          )}
...
SendOtpInput.displayName = "SendOtpInput";
