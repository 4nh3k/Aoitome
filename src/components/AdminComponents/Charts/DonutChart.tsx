...
const DonutChart = () => {
  ...
  const handleCheckboxChange = (e, chart: ApexCharts) => {
        ...
        <div className="flex justify-center items-center">
          ...
          >
            <div className="p-3 space-y-2">
              ...
              <a
                href="#"
                className="flex items-center font-medium text-yellow-500 dark:text-blue-500 dark:hover:text-yellow-500 hover:text-primary hover:underline"
              >
                Read more{" "}
                <svg
        ...
        <div className="flex" id="devices">
          <div className="flex items-center me-4">
            <input
              ...
              type="checkbox"
              value="desktop"
              className="w-4 h-4 text-yellow-500 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-yellow-500 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
            />
            <label
              htmlFor="desktop"
